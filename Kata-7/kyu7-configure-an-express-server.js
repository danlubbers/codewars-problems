// https://www.codewars.com/kata/configure-an-express-server/train/javascript
...
const solution = () => {
    ...
    app.listen(process.env.PORT, process.env.HOST, () => console.log(`Listening on ${process.env.PORT}`))
};