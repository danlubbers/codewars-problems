// https://www.codewars.com/kata/special-number-special-numbers-series-number-5/train/javascript
...
function specialNumber(n){
    let regex = new RegExp(/[6-9]/);
    return regex.test(n) ? 'NOT!!' : 'Special!!';
}
