// https://www.codewars.com/kata/safen-user-input-part-i-htmlspecialchars/train/javascript
...
function htmlspecialchars(formData) {
    let regex = /[<>"&]/g;
    return formData.replace(regex,
    char => ({ '<': '&lt;', '>': '&gt;', '"': '&quot;', '&': '&amp;' }[char]));
}

// Best Practice and my frist attempt 
function htmlspecialchars(formData) {
...
console.log(htmlspecialchars('Hello World'), '&lt;h2&gt;Hello World&lt;/h2&gt;')
