...
function seatsInTheater(nCols, nRows, col, row) {
    // Total Column of seats - column you are in and add one so that you are in front of the column
    // then total row of seats minus the row you are in
    // Multiply the two to get the total number of seats behind and to the left of you
